...
namespace ConsoleMenu.Methods__Controllers.Boats
{
    public class BookingMenuMethod
    {
        ...
        //}
        //public void EventMenu(string theChoices, Member? member, BookingRepo bookingRepo)
        //{
        ...
        //                        for(int i = 0; bookingRepo.count > i; i++)
        //                            // print datetime start and datetime end and name of the member that booked the time
        //                        bookingRepo.;
        //                        Console.WriteLine("Choose event by writing its title. Press \"q\" to quit.");
